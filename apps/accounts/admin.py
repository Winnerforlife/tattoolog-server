...
class ProfileAdmin(admin.ModelAdmin):
    ...
    list_filter = ('status', 'open_to_work', 'mentor', 'relocate', 'trusted_mentor', 'posted_in_journal')
...
class UserAdmin(UserAdmin):
    ...
    list_display = (
        'username', 'email', 'phone_number', 'first_name', 'last_name', 'is_active', 'is_staff', 'is_admin',)
